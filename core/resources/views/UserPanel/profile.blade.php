                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group col-md-12">
                                            <div class="col-md-6 {{ $errors->has('first_name') ? ' has-error' : '' }}">
                                                ...
                                                <input value="{{ Auth::user()->first_name }}" type="text"  class="form-control" name="first_name" placeholder="First Name">
                                        ...
                                        <div class="col-md-12">
                                            <button type="submit" style="margin-top: 20px;" class="btn-primary btn btn-lg btn-block"><a href="{{ route('security.index') }}" style="color:#fff;">Change Password</a></button>
                                        </div>
                                    </div>
                                        </div>
