                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                @foreach($add as $key => $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->remain }}</td>
                                        <td>
                                            <a class="btn blue-ebonyclay" href="{{route('add.view.admin', $data->id)}}"><i class="fas fa-edit"></i></a>
                                            <a class="btn red" data-toggle="modal" href="#deleteModal{{$data->id}}"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
