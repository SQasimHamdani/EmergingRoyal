...
<head>
    ...
    <!--Responsive CSS-->
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/assets/fonts/css/responsive.css">
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="{{url('/')}}">
                                <img style=" max-width: 160px;" src="{{asset('assets/images/fontend_logo/logo.png')}}" class="img-responsive" alt="Image">
                            </a>
                        </div>
                        ...
                        <div class="collapse navbar-collapse navbar-ex1-collapse">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a @if(request()->path() == '/') href="#pricing-area" @else href="{{url('/')}}" @endif>Plans</a></li>
