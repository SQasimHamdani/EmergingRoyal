            ...
            <div class="container">
                ...
                <div class="wrapper fadeInDown">
                    <div id="formContent">
                        ...
                        <!-- Login Form -->
                        <form method="post" action="{{ route('FrontEndactionRegister') }}">
                            {{csrf_field()}}


                            <div class="row">
                                <div class="col-md-6">
                                    <input required type="text" placeholder="First Name" value="{{old('first_name')}}" name="first_name">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" id="datepicker" placeholder="Birth Date" value="{{old('birth_day')}}" name="birth_day">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input required type="text" placeholder="Street Address" value="{{old('street_address')}}" name="street_address">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" required placeholder="Post Code" value="{{old('post_code')}}" name="post_code">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input required type="password" id="password" placeholder="Password" value="{{old('password')}}"  name="password">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="checkbox" >
                                        ...
                                        Agree with the <a  href="{{url('terms')}}"> Terms</a> and <a href="{{url('policy')}}"> Policy</a>
                                    </div>
                                </div>
                            </div>
