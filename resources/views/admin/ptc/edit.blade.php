                ...
                <div class="col-md-6 col-md-offset-3" style="margin-top: 50px;">
                    <div class="portlet box blue-ebonyclay">
                        ...
                        <div class="portlet-body">
                            <form class="form-horizontal" role="form" method="post" action="{{route('update.addvertise', $add->id)}}">
                                {{csrf_field()}}
                                {{ method_field('put') }}
                                <input type="hidden" name="token" value="{{str_random()}}">
                                     <div class="form-group">
                                         <div class="col-md-12">
                                             ...
                                             <div class="col-md-12">
                                                 <input class="form-control"  type="text" value="{{$add->title}}" required name="title">
                                             </div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="form-group">
                                         <div class="col-md-12">
                                             ...
                                             <div class="col-md-12">
                                                 <input class="form-control"  value="{{$add->link}}" type="text" required name="link">
                                             </div>
                                         </div>
                                     </div>
                                       ...
                                       <div class="col-md-12">
                                           ...
                                           <div class="col-md-12">
                                               <div class="input-group">
                                                   <input type="text" class="form-control" name="price" disabled value="{{$add->price}}">
                                   ...
                                   <div class="form-group">
                                       <div class="col-md-12">
                                           ...
                                           <div class="col-md-12">
                                               <input class="form-control" disabled value="{{$add->quantity}}" type="text" required name="quantity">
                                           </div>
                                       </div>
                                   </div>
                                <div class="row">
