                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                @foreach($add as $key => $data)
                                    <tr>
                                        ...
                                        <td>@if($data->status == 0)<p class="text text-danger">Already Viewed</p> @else  <a target="_blank" href="{{route('iframe.open', $data->advertise->token)}}">Click Here</a>  @endif</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
...
@section('script')
    <script>
        ...
        //Reloads the Webpage on window Changing
        vis(function(){
            location.reload();
        });
